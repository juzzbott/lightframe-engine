...
Mesh Mesh::createCubeMesh() {
    ...
    std::vector<float> cubeVertices = {
        ...
        0.5f,-0.5f, 0.5f, 0.75f, 0.40f, 0.90f, 0.0f, 1.0f,
        0.5f, 0.5f, 0.5f, 0.80f, 0.45f, 0.95f, 1.0f, 1.0f,
        -0.5f, 0.5f, 0.5f, 0.72f, 0.38f, 0.88f, 1.0f, 0.0f,

        // -Z face
        0.5f,-0.5f,-0.5f, 0.35f, 0.35f, 0.35f, 0.0f, 0.0f,
        -0.5f,-0.5f,-0.5f, 0.45f, 0.45f, 0.45f, 0.0f, 1.0f,
        -0.5f, 0.5f,-0.5f, 0.55f, 0.55f, 0.55f, 1.0f, 1.0f,
        0.5f, 0.5f,-0.5f, 0.65f, 0.65f, 0.65f, 1.0f, 0.0f,
    };
