...
Mesh Mesh::createCubeMesh() {
    ...
    std::vector<float> cubeVertices = {
        // +X face
        0.5f,-0.5f,-0.5f, 0.92f, 0.23f, 0.18f,
        0.5f, 0.5f,-0.5f, 0.85f, 0.31f, 0.22f,
        0.5f, 0.5f, 0.5f, 0.88f, 0.40f, 0.30f,
        0.5f,-0.5f, 0.5f, 0.95f, 0.28f, 0.20f,

        // -X face
        -0.5f,-0.5f, 0.5f, 0.18f, 0.60f, 0.85f,
        -0.5f, 0.5f, 0.5f, 0.22f, 0.65f, 0.90f,
        -0.5f, 0.5f,-0.5f, 0.30f, 0.70f, 0.95f,
        -0.5f,-0.5f,-0.5f, 0.15f, 0.55f, 0.80f,

        // +Y face
        -0.5f, 0.5f,-0.5f, 0.30f, 0.85f, 0.35f,
        -0.5f, 0.5f, 0.5f, 0.40f, 0.90f, 0.45f,
         0.5f, 0.5f, 0.5f, 0.50f, 0.95f, 0.55f,
         0.5f, 0.5f,-0.5f, 0.35f, 0.88f, 0.40f,

        // -Y face
        -0.5f,-0.5f, 0.5f, 0.75f, 0.75f, 0.20f,
        -0.5f,-0.5f,-0.5f, 0.80f, 0.80f, 0.25f,
         0.5f,-0.5f,-0.5f, 0.85f, 0.85f, 0.30f,
         0.5f,-0.5f, 0.5f, 0.78f, 0.78f, 0.22f,

        // +Z face
        -0.5f,-0.5f, 0.5f, 0.70f, 0.35f, 0.85f,
         0.5f,-0.5f, 0.5f, 0.75f, 0.40f, 0.90f,
         0.5f, 0.5f, 0.5f, 0.80f, 0.45f, 0.95f,
        -0.5f, 0.5f, 0.5f, 0.72f, 0.38f, 0.88f,
